...
export default function AdminSidebar() {
  ...
  return (
    <>
      {/* Mobile menu button */}
      <button
        className="fixed top-4 left-4 z-50 md:hidden bg-primary text-white p-2 rounded-md shadow-md hover:bg-primary-dark transition-colors"
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-40 bg-white dark:bg-gray-800 shadow-lg transform transition-all duration-300 ease-in-out md:translate-x-0',
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 border-b border-gray-200 dark:border-gray-700 px-4">
            ...
            <button
              className="hidden md:flex items-center justify-center p-2 rounded-md text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
              ...
              {navItems.map((item) => (
                ...
                >
                  ...
                  {isCollapsed && item.submenu && (
                    <div className="absolute left-full top-0 ml-2 w-48 rounded-md shadow-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hidden group-hover:block z-50">
                      <ul className="py-1">
